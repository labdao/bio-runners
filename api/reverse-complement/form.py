...
#
# Reverse Complement
# - Call this like a normal API / serverless endpoint, with POST form data
...
@app.post("/api/reverse-complement/form")
async def reverse(sequence: str = Form(...)):
    print('sequence:', sequence)
    seq = Seq(sequence)
    return {"output": str(seq.reverse_complement())}


# implement GET with a param
